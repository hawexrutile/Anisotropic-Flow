...
/*   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("AuAu200GeV_SM3mb_Alpha0p47_NT150_DecayOff_0_20fm_file1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("AuAu200GeV_SM3mb_Alpha0p47_NT150_DecayOff_0_20fm_file1.root");
      }
      f->GetObject("tr",tree);
