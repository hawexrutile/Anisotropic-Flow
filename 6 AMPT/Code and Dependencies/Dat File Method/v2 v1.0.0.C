...
//!This Code gives a single v2 as output for all the events
//! I was kinda dumb, but this is a prototype to calculate v2
//! And for some reason it draws Phi Distriibution(its probably incorrect though)
//! Dont forget to load LoadThis.cpp
//! For understanding the variable reffer LoadThis.cpp
{
    double v2=0;
    double IntegNum=0;
    double IntegDen=0;
